...
//     let xStockItems = [...items];
//     console.log(xStockItems)
//     const selectedStockItem = xStockItems[index];
//     // update instock qty
//     xStockItems.instock = xStockItems.instock - 1
//     // substitute old object with new
//     xStockItems.splice(index, 1, selectedStockItem);
//     setItems(xStockItems)
...
//     const matchingCartItem = cart.find(item => item.name === stockItems[index].name);
//     // Increase inCart Qty or add if not in list yet
//     if (matchingCartItem === undefined) {
//         const newCartItem = {
//             name: xStockItems.name,
//             cost: xStockItems.cost,
//             inCart: 1
//         }
...
//         const indexUpdatedItem = cart.findIndex(item => item.name === xStockItems.name)
